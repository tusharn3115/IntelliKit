...
const AiTools = () => {
  ...
  return (
    <div id='tools' className='px-4 sm:px-20 xl:px-32 my-24'>
        <div className='text-center'>
            <h2 className='text-slate-700 text-[42px] font-semibold'>High-Performance AI Tools</h2>
            <p className='text-gray-500 max-w-lg mx-auto'>All you need to create, enhance, and optimize your content — powered by cutting-edge AI tools.</p>
        </div>
